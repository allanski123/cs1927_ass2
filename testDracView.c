...
int main()
{
    ...
    dv = newDracView("GED.... SGE.... HZU.... MCA.... DCFTV.. " 
                     "GMN.... SCFTVD. HGE.... MLS.... DBOT... " 
                     "GLO.... SMR.... HCF.... MMA.... DTOTV.. " 
                     "GPL.... SMS.... HMR.... MGR.... DBAT... " 
                     "GLO.... SBATD.. HMS.... MMA.... DSRT... " 
                     "GPL.... SSJ.... HBA.... MGR....", messages3);
    int nT, nV;
    whatsThere(dv,EDINBURGH,&nT,&nV);
    assert(nT == 0 && nV == 0);
    whatsThere(dv,CLERMONT_FERRAND,&nT,&nV);
    assert(nT == 0 && nV == 0);
    whatsThere(dv,TOULOUSE,&nT,&nV);
    assert(nT == 1 && nV == 1);
    whatsThere(dv,BORDEAUX,&nT,&nV);
    assert(nT == 1 && nV == 0);
